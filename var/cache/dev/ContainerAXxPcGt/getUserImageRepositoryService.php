...
// Returns the private 'App\Repository\UserImageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UserImageRepository.php';

return $this->privates['App\Repository\UserImageRepository'] = new \App\Repository\UserImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
