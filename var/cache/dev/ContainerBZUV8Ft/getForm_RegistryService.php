...
}, 'App\\Form\\ObservationType' => function () {
    return ($this->privates['App\Form\ObservationType'] ?? $this->privates['App\Form\ObservationType'] = new \App\Form\ObservationType());
}, 'App\\Form\\ResearchBirdType' => function () {
    return ($this->privates['App\Form\ResearchBirdType'] ?? $this->privates['App\Form\ResearchBirdType'] = new \App\Form\ResearchBirdType());
}, 'App\\Form\\SubscriptionType' => function () {
    return ($this->privates['App\Form\SubscriptionType'] ?? $this->privates['App\Form\SubscriptionType'] = new \App\Form\SubscriptionType());
}, 'App\\Form\\UserModifyType' => function () {
    return ($this->privates['App\Form\UserModifyType'] ?? $this->privates['App\Form\UserModifyType'] = new \App\Form\UserModifyType());
