...
// Returns the private 'App\Repository\AvesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AvesRepository.php';

return $this->privates['App\Repository\AvesRepository'] = new \App\Repository\AvesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
