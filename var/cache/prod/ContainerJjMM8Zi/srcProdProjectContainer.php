...
class srcProdProjectContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3yugW8fc9R', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.save_path': $value = ($this->targetDirs[3].'\\src/../var/sessions/prod'); break;
