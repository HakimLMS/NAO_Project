 ...
 */
class Version20180130184409 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE observations ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_BBC15BA8A76ED395 ON observations');
        $this->addSql('ALTER TABLE observations DROP user_id');
    }
}
